...
const RESOURCE_FIELDS: Record<string, string[]> = {
  ...
  order_doweling_links: [
    ...
    "order_id",
    "doweling_order_id",
    "doweling_order { doweling_order_id doweling_order_name design_engineer_id operator_id payment_status_id production_status_id doweling_order_date parts_count total_amount discounted_amount discount paid_amount payment_date issue_date }",

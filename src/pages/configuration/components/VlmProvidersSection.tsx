...
import { Card, Button, Space, Modal, Form, Input, InputNumber, Switch, Tag, message, Popconfirm } from 'antd';
import {
  PlusOutlined,
  EditOutlined,
  DeleteOutlined,
    ...
    },
    {
      ...
      render: (_: any, record: VlmProvider) => (
        <Space size="small">
          ...
          <Popconfirm
            title={<PopconfirmContent title="Удалить провайдера?" description={`"${record.name}" будет удалён вместе со всеми моделями`} />}

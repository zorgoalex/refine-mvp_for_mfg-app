...
import { DISPLAY_DATE_FORMAT, DISPLAY_DATE_TIME_SECONDS_FORMAT } from "../../utils/dateFormat";
...
export const OrderWorkshopShow: React.FC<IResourceComponentsProps> = () => {
  ...
  return (
    <Show isLoading={isLoading}>
      ...
      <DateField value={record?.received_date} format={DISPLAY_DATE_TIME_SECONDS_FORMAT} />
      <Title level={5}>Started Date</Title>
      <DateField value={record?.started_date} format={DISPLAY_DATE_TIME_SECONDS_FORMAT} />
      <Title level={5}>Completed Date</Title>
      <DateField value={record?.completed_date} format={DISPLAY_DATE_TIME_SECONDS_FORMAT} />
      <Title level={5}>Planned Completion Date</Title>
      <DateField value={record?.planned_completion_date} format={DISPLAY_DATE_FORMAT} />

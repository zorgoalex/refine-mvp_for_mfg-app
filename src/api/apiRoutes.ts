...
export const apiRoutes = {
  ...
  cncTelegram: {
    ...
    mdfBoardHistoryOrders: backendApiPath('/cnc-telegram/mdf-board/history/orders'),
    mdfBoardHistory: (orderId: number) => backendApiPath(`/cnc-telegram/mdf-board/history/${orderId}`),
  ...
  whatsapp: {
    ...
    templateById: (id: number) => backendApiPath(`/whatsapp/templates/${id}`),
    rules: backendApiPath('/whatsapp/rules'),
    ruleById: (id: number) => backendApiPath(`/whatsapp/rules/${id}`),
    queue: backendApiPath('/whatsapp/queue'),

-- Separate visible machine-file cards from internal packets that seed a
-- manually requested vacuum-bath card on the MDF board.
...
SELECT DISTINCT packet.packet_id, lower(trim(order_match.match[2]))

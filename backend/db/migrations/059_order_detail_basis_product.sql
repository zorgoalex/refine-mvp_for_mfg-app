-- Store non-numeric product part from Basis PDF "Обозн. проект" separately.
ALTER TABLE order_details
  ADD COLUMN IF NOT EXISTS basis_product TEXT NULL;

COMMENT ON COLUMN order_details.basis_product IS 'Basis product name parsed from the non-numeric part of PDF project designation';

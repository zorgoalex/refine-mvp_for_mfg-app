...
type GroupOrderRelationCountsReportTemporalFilter = Exclude<GroupReportFilter['temporal'], { mode: 'factTime' }>;
type GroupOrderRelationCountsReportPredicateFilter =
  | { mode: 'none'; temporal: GroupOrderRelationCountsReportTemporalFilter }
  | {
      mode: Exclude<GroupReportFilterMode, 'none'>;
      groupIds: string[];
      temporal: GroupOrderRelationCountsReportTemporalFilter;
    };
type GroupOrderRelationCountsReportResponseFilter =
...
export interface GroupOrderRelationCountsReportQuery {
  predicateFilter: GroupOrderRelationCountsReportPredicateFilter;
  responseFilter: GroupOrderRelationCountsReportResponseFilter;
}

export type GroupOrderRelationType = 'main' | 'secondary' | 'reporting' | 'billing' | 'derived';

export interface GroupOrderRelationCountsReportItemDto {
  relationType: GroupOrderRelationType;
  isPrimary: boolean;
  orderCount: number;
}

export interface GroupOrderRelationCountsReportResponseDto {
  data: GroupOrderRelationCountsReportItemDto[];
  filter: GroupOrderRelationCountsReportResponseFilter;
}

export function parseGroupOrderRelationCountsReportQuery(
...
function parseTemporal(query: Record<string, string | string[] | undefined>): GroupOrderRelationCountsReportTemporalFilter {
...
function toResponseFilter(
  filter: GroupOrderRelationCountsReportPredicateFilter,
): GroupOrderRelationCountsReportResponseFilter {

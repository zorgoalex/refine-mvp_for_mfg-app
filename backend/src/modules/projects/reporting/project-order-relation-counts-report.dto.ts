...
type ProjectOrderRelationCountsReportTemporalFilter = Exclude<ProjectReportFilter['temporal'], { mode: 'factTime' }>;
type ProjectOrderRelationCountsReportPredicateFilter =
  | { mode: 'none'; temporal: ProjectOrderRelationCountsReportTemporalFilter }
  | {
      mode: Exclude<ProjectReportFilterMode, 'none'>;
      projectIds: string[];
      temporal: ProjectOrderRelationCountsReportTemporalFilter;
    };
type ProjectOrderRelationCountsReportResponseFilter =
...
export interface ProjectOrderRelationCountsReportQuery {
  predicateFilter: ProjectOrderRelationCountsReportPredicateFilter;
  responseFilter: ProjectOrderRelationCountsReportResponseFilter;
}

export type ProjectOrderRelationType = 'main' | 'secondary' | 'reporting' | 'billing' | 'derived';

export interface ProjectOrderRelationCountsReportItemDto {
  relationType: ProjectOrderRelationType;
  isPrimary: boolean;
  orderCount: number;
}

export interface ProjectOrderRelationCountsReportResponseDto {
  data: ProjectOrderRelationCountsReportItemDto[];
  filter: ProjectOrderRelationCountsReportResponseFilter;
}

export function parseProjectOrderRelationCountsReportQuery(
...
function parseTemporal(query: Record<string, string | string[] | undefined>): ProjectOrderRelationCountsReportTemporalFilter {
...
function toResponseFilter(
  filter: ProjectOrderRelationCountsReportPredicateFilter,
): ProjectOrderRelationCountsReportResponseFilter {

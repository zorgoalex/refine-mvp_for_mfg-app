 ...
 * writer or by the narrow statement-level compatibility bridge in migration 097.
...
export const ORDER_REALTIME_PRODUCER_MATRIX: readonly OrderRealtimeProducerMatrixRow[] = [
  {
    ...
    producer: '097:trg_order_realtime_detail_status_insert/update/delete',
    noOpRule: 'only snapshot-visible old/new rows emit; bridge is not an audit sink',
    test: '097_order_realtime_producer_bridge.test.ts',
  },
  {
    writerPaths: ['order delete/restore'],
    mutatedTables: ['orders'],
    domains: ['detail_status', 'cut_refs'],
    producer: '097:trg_order_realtime_order_visibility_update',
  ...
  },
  {
    ...
    domains: ['cut_refs'],
    producer: '097:trg_order_realtime_cut_item_insert/update/delete',
  ...
  },
  {
    ...
    domains: ['cut_refs'],
    producer: '097:trg_order_realtime_cut_job_update',
  ...
  },
  {
    ...
    domains: ['cut_refs'],
    producer: '097:trg_order_realtime_cut_archive_insert/delete',
  ...
  },
  {
    ...
    domains: ['cut_refs'],
    producer: '097:trg_order_realtime_cut_profile_update',

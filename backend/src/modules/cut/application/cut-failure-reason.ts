...
const REASON_BY_CODE: Record<string, string> = {
  ...
  CUT_OPTIMIZER_INVALID_GEOMETRY:
    'Оптимизатор вернул раскрой с нарушением границ, направления текстуры или обязательного зазора. Расчёт не сохранён; обновите сервис Freecut и повторите попытку.',

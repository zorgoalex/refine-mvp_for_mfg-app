...
- Frontend: `https://app-test.example.com`
- Backend: `https://backend-test.example.com`
- Backend API: `https://backend-test.example.com/api/v1`
...
| Legacy Vercel production-disable does not break `/runtime-config.json` | Pass | Runtime config gate and staging gates both loaded `https://app-test.example.com/runtime-config.json` successfully. |

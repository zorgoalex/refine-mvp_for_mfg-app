...
- Статус: **MVP завершен** (2025-10-28)
...
## Дальнейшие шаги (Roadmap)
- Расширить CRUD для `orders` (полноценное редактирование в базовой таблице, не только read-only view).
...
- Решить проблему JSX артефактов для полной централизации is_active helper.
